...
<?$ElementID = $APPLICATION->IncludeComponent(
	...
	"",
	array(
		"DNTSHOW_PROPERTY" => $arParams["DNTSHOW_PROPERTY"],
...
<div class="order_proj">
    <div class="popformzag"><?=GetMessage('FORM_ORDER_PROJ')?></div>
    <?$APPLICATION->IncludeComponent(
        ...
        array(
            ...
            "IBLOCK_ID" => VH::IBID("form_order"),
            "USE_CAPTCHA" => "Y",
            "OK_TEXT" => GetMessage('FORM_OK_TEST'),
            "MAIL_TITLE" => GetMessage('FORM_ORDER_PROJ').' '.$_SERVER['HTTP_HOST'],
