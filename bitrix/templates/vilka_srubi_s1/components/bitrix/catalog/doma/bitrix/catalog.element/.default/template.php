            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="price-inner">
                        ...
                        <button data-message="Оформление заявки" class="zz_btn"><?= GetMessage("VR_ORDER") ?></button><br>
                        <button data-message="Этот дом в ипотеку" class="zz_btn ipoteka-button"><?= GetMessage("VR_ORDER_IPOTEKA") ?></button>
                    </div>
                </div>
            </div>
        </div>
