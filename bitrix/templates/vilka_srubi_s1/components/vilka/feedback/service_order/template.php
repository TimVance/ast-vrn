...
?>
<div class="vilka_feedback service_order">

    <h2><?=GetMessage("MFT_TITLE_FORM_SERVICE");?></h2>
...
<!--    --><?//}?>
    ...
    <?if($arParams["USE_CAPTCHA"] == "Y"){?>
        ...
        <div class="recapthca-wrapper" id="recaptcha_<?=$arParams['FORM_ID']?>"></div>
    <?}?>
...
<script>
    $(function () {
        $("#FORM_NAME_FID_service_order").val($("h1").text());
    });
</script>
